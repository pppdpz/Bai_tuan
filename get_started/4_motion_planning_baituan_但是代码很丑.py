...
# ---- _InlineRobotStub：替代 mjcf_model 作为 mj_objects 中的存根 ----
# 正常流程中 mj_objects[robot.name] 是 robot_xml（一个 mjcf.RootElement），
# 其 .model 属性是机器人的命名空间前缀（如 "ur5e"），.full_identifier 是 "ur5e/"。
# 内嵌场景没有这个前缀，所以用存根替代。
